function createParagraph() {
    ...
    var paragraph = "Hello, my fellow " + wordOne + " in 2020, it's me, George Washignton, the first " + wordTwo +". I am writing from (the) " + wordThree +", where I have been seceretly living for the past " + wordFour + " years. I am concerned by the " + wordFive + " state of affairs in America these days. It seems that your politicians are more concerned with " + wordSix + " one  another that with listening to the " + wordSeven + " of the people. When we declared our independence from (the) " + wordEigth + ", we set forth on a/an " + wordNine + " path guided by the voices of the everyday " + wordTen + " If we're going to keep " + wordEleven +", then we need to learn how to respect all " + wordTwelve +". Don't get me wrong: we had " + wordThirteen +" problems in my day, too. Benjamin Franklin once called me a/an " + wordFourteen +" and kicked me in the " + wordFifteen + ". But at the end of the day, we were able to " + wordSixteen + " in harmony. Let us find that " + wordSeventeen + " spirit once again, or else I'm taking my " + wordEighteen + " off the quarter!";
